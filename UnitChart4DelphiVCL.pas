...
uses
   Vcl.Graphics, Vcl.Controls, System.JSON, System.SysUtils, System.Types,
   System.Generics.Collections, System.Classes, Winapi.Windows;
...
type
  TVCLChart4Delphi = class // Renomeado para evitar conflitos
  private
    FPaintBox: TPaintBox; // Substitui FLayout
    FChartType: TChartLayoutType;
    FArrValues: TJSONArray;
    FColorsGraph: TArray<TColor>; // TColor para VCL
    FColorsText: TArray<TColor>; // TColor para VCL
    ...
    FColorLinePoint: TColor; // TColor para VCL
    FTimer: TTimer; // Para animação
    ...
    procedure TimerOnTimer(Sender: TObject); // Para animação
  public
    constructor Create(PaintBox: TPaintBox; ChartType: TChartLayoutType);
    destructor Destroy; override;

    procedure Clear;
    procedure SetColors(ColorsGraph, ColorsText: Array of TColor);
